  ...
  <>
    <Container>
      ...
      <List>
        ...
        <Description>
          <p>
            SES 企業に勤めていた頃、外部プロジェクトへの支援として PHP で作られたシステムの改修を何度か行ったことがあります。また、個人事業を開業して最初の仕事は CakePHP のシステム改修でした。Laravel 等で1からシステムを開発した経験はありませんが、基礎的な仕事を多少行うことはできます。また、過去のブログやポータルサイトは WordPress で構築しました。現在勤めている企業でも多くのコンテンツ配信サイトは WordPress で構築しています。
          </p>
        </Description>
        ...
        <Description>
          <p>
            C++ は、Embarcadero の <ExLink href="https://www.embarcadero.com/jp/products/cbuilder">C++Builder</ExLink> を使って Windows のアプリケーションを開発していました。上述の組み込みアプリケーションと同様、TCP, UDP, RTP 等のプロトコルで電文や音声の通信を行うアプリケーションを多く開発していました。ブログに技術記事も多く執筆しており、以下の記事は現代においても一定のアクセスがあります。
          </p>
